...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.MyViewHolder>{
    ...
    public RVAdapter(Context mContext, List<Book> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        viewHolder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext , Book_Details.class);
                ...
                i.putExtra("language",mData.get(pos).getLanguage());
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        holder.tvCategory.setText(book.getLanguage());

        String url;
        url = book.getThumbnail().substring(0,4) + "s" + book.getThumbnail().substring(4, book.getThumbnail().length());
